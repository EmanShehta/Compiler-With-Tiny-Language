...
{
   T_Int_DataType , T_Float_DataType, T_String_DataType , T_Read , T_Write , T_Repeat , T_Until , T_If , T_Elseif , T_Else , T_Then , T_Return , T_Endl,
    T_Dot, T_Semicolon, T_Comma, T_LParanthesis, T_RParanthesis, T_EqualOp, T_LessThanOp, T_String, T_comment, T_assign,
    T_GreaterThanOp, T_NotEqualOp, T_PlusOp, T_MinusOp, T_MultiplyOp, T_DivideOp,
    T_Idenifier, T_Rightbracket, T_Leftbracket , T_AndOp , T_OROp , T_Number ,  T_Main , T_End
}
namespace TINY_Compiler
{
    ...
    public class Scanner
    {
        ...
        void FindTokenClass(string Lex)
        {
            ...
            Regex r3= new Regex(@"\/\*.*\*\/", RegexOptions.Compiled);
